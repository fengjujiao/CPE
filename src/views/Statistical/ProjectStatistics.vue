<template>
  <div>
    <p class="mainTitle">工程项目工作状态统计</p>
    <topStatistics :otherTop1="2"></topStatistics>
    <el-table :data="tableData1" style="width: 100%">
      <el-table-column label="序号" type="index" width="50"></el-table-column>
      <el-table-column prop="epCode" label="工程编号" width="150"></el-table-column>
      <el-table-column prop="epName" label="工程名称" width="200"></el-table-column>
  ...
  methods: {
    ...
    async tabledataFn(satrt, end, employees) {
      ...
      let { data } = await this.axios.post(
        "/api/mh/statisticalAnalysisEngineering",
        this.pageParams
      );
      //console.log(data);
      let _sum = 0;
